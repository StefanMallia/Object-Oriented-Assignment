...
public class TruthQuestion extends QuestionObject {

	
	public TruthQuestion(List<String> textToParse, StringBuilder answerGiven) {
	...
	public int promptUser() throws InvalidInput {
		...
		System.out.println("Pick the correct answer (0 or 1)");
